    ...
    t.extend(t.fn, {
        ...
        t.extend(t.validator, {
            ...
            messages: {
                ...
                maxlength: t.validator.format("Enter no more than {0} characters."),
                minlength: t.validator.format("Enter at least {0} characters."),
                rangelength: t.validator.format("Enter a value between {0} and {1} characters long."),
                range: t.validator.format("Enter a value between {0} and {1}."),
                max: t.validator.format("Enter a value less than or equal to {0}."),
                min: t.validator.format("Enter a value greater than or equal to {0}."),
            },
            autoCreateRanges: !1,
            prototype: {
                init: function() {
                    ...
                    s.length ?
                        ...
                        ((s = t("<" + this.settings.errorElement + ">")
                            ...
                            (s = s
                                ...
                                .parent()),
                            this.labelContainer.append(s).length || (this.settings.errorPlacement ? this.settings.errorPlacement(s, t(e)) : s.insertAfter(e))), !i && this.settings.success && (s.text(""), "string" == typeof this.settings.success ? s.addClass(this.settings.success) : this.settings.success(s, e)),
