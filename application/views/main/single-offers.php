				...
				<div class="col-xl-8 col-lg-8 content-right-offset">
					...
					<div class="imil-box margin-bottom-30">
						<div class="slippa-box-style-2">
							...
							<div class="row margin-top-50">
								...
								<div class="col-lg-4">
									<?php if ($listing_data[0]['listing_type'] !== 'app') { ?>
										<span class="d-block f-size-24 slippa-semiblod"><?php if (!empty($alexaRank['globalRank'][0])) echo number_format($alexaRank['globalRank'][0]);
																						else echo 'N/A'; ?></span>
										<span class="d-block f-size-16 slippa-light3">Alexa</span>
									<?php } else { ?>
										<span class="d-block f-size-24 slippa-semiblod"><?php if (!empty($listing_data[0]['monthly_downloads'])) echo number_format($listing_data[0]['monthly_downloads']);
																						else echo 'N/A'; ?></span>
										<span class="d-block f-size-16 slippa-light3">Downloads</span>
									<?php } ?>
								</div>
					...
					<?php if ($listing_data[0]['listing_type'] === 'website' && $settings[0]['active_domain_screenshots'] === '1') { ?>
						...
						<div class="slippa-box-style-2 margin-bottom-30 content-right-offset">
							<span class="f-size-24 d-block margin-bottom-30">
						...
						<?php if (!empty($this->session->userdata('user_id'))) { ?>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="content">
											...
											<?php } else { ?>
												<h3 class="margin-bottom-25">About App</h3>
											<?php } ?>
											<p class="description-width"><?php if (isset($listing_data[0]['description'])) if (DECODE_DESCRIPTIONS) echo html_entity_decode(($listing_data[0]['description']));
																			else echo ($listing_data[0]['description']); ?></p>
										</div>
									</div>
								</div>
							</div>
							...
							<?php if (!empty($listing_data[0]['website_how_make_money'])) { ?>
								...
								<div class="single-page-section">
									...
									<?php } else { ?>
										<h3 class="margin-bottom-25">How does your App make money?</h3>
									<?php } ?>
							...
							<?php if (!empty($listing_data[0]['website_whyselling'])) { ?>
								...
								<div class="single-page-section">
									...
									<?php } else { ?>
										<h3 class="margin-bottom-25">Why are you selling this app?</h3>
									<?php } ?>
					...
					<div class="sidebar-container">
						...
						<div class="sidebar-widget">
							<div class="bidding-widget">
								<div class="bidding-headline centerButtons">
									<h3><?php echo strtoupper('Make an offer !');  ?></h3>
								</div>
										...
										if ($listing_data[0]['sold_status'] === '0') { ?>
											...
											<?php if ($listing_data[0]['user_id'] !== $this->session->userdata('user_id')) { ?>
												<?php if (!empty($listing_data[0]['website_buynowprice'])) { ?>
													<!-- Button -->
													<a href="<?php echo base_url() . 'checkout/' . 'buynow' . '/' . $listing_data[0]['id']; ?>" class="button ripple-effect move-on-hover full-width margin-top-20"><span>BUY IT NOW FOR <?php if (!empty($default_currency)) echo $default_currency;
																																																									else echo '$'; ?> <?php if (!empty($listing_data[0]['website_buynowprice'])) echo number_format($listing_data[0]['website_buynowprice']); ?></span></a>
											<?php }
											} ?>
										<?php } else { ?>
										...
										<ul>
											<?php if ($listing_data[0]['listing_type'] !== 'app') { ?>
												<li>
													...
													<h5><?php if (!empty($alexaRank['globalRank'][0])) echo number_format($alexaRank['globalRank'][0]);
														else echo 'N/A'; ?></h5>
												</li>
											<?php } else { ?>
												<li>
													...
													<span>DOWNLOADS</span>
													<h5><?php if (!empty($listing_data[0]['monthly_downloads'])) echo number_format($listing_data[0]['monthly_downloads']);
														else echo 'N/A'; ?></h5>
												</li>
												...
												<li>
													...
													<h5><?php if (strpos($listing_data[0]['app_market'], 'google') !== false) echo 'Android App';
														else if (strpos($listing_data[0]['app_market'], 'apple') !== false) echo 'IOS App';
														else echo 'N/A'; ?></h5>
												</li>
											<?php } ?>
											...
											<?php if ($listing_data[0]['listing_type'] !== 'domain') { ?>
												<li>
													...
													<h5><?php if (isset($default_currency)) echo $default_currency;
														else echo '$'; ?> <?php if (isset($listing_data[0]['annual_profit'])) echo number_format($listing_data[0]['annual_profit']); ?></h5>
												</li>
											<?php } ?>
