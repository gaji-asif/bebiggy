...
<section class="shopify_latest_section_a" id="latest-shopfiy-store">
    <div class="container">
        ...
        <div class="col-12 col-md-12">
                ...
                <a href="<?php echo site_url('product-category/shopify-latest-dropship-websites-for-sale'); ?>#latest-shopfiy-store" class="new_btn btn_blue">Latest Shopify Stores</a>
            </div>
        </div>
    </div>
    ...
    <div id="viewProduct">
        <!-- start:ajax -->
        <div class="container-fluid ecommerce_div" id="solution">
