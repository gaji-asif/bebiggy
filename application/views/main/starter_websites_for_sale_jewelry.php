                            ...
                            <div class="page-banner">
                                <div>
                                    <div class="aboutpara_text">
                                        <p>Online Jewellery Store For Sale <br />Want To Start Your Online Jewellery Store?</p>
                                    </div>
                                    <div class="blogslider_title">
                                        <h2><?php echo $this->lang->line('uppercase_site_name'); ?> Offers Turnkey <br/>Jewellery Websites</h2>
                                    </div>
                                    <div class="website_start_now_a">
                                        <a href="<?php echo site_url('product-category/jewelry') ?>"><span>Start Now</span><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="container-fluid about_para_a">
        ...
        <div class="container">
            ...
            <div class="col-md-6 px-2">
                <p>The global online jewelry market is on the rise, and the key growth factor is the compatibility of consumers with social and digital platforms. In addition, services such as free shipping and product returns that enhance consumer experience are also playing an important role.</p>
                <p>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 pr-2">
                    <ul>
                        <li>Online sales of jewelry are expected to increase, boosting revenue and sustaining profit.</li>
                        <li>The market for online jewelry and watch retailers is expected to saturate.</li>
                       
                    </ul>
                </div>
                <div class="col-md-6 pr-2">
                    <ul>
                        <li>The industry is expected to benefit from increased consumer affinity and interaction.</li>
...
<section class="jewelry_last_section">
