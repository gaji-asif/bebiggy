	...
	<div class="row">
		...
		<div class="imil-box margin-bottom-30">
            <div class="slippa-box-style-2">
                ...
                <span class="badge badge-danger" title="<?php if(strpos($listing_data[0]['app_market'], 'google') !== false) echo 'ANDROID APP'; else if(strpos($listing_data[0]['app_market'], 'apple') !== false) echo 'IOS APP'; else echo 'N/A'; ?>" data-tippy-placement="top"><?php if(strpos($listing_data[0]['app_market'], 'google') !== false) echo 'ANDROID'; else if(strpos($listing_data[0]['app_market'], 'apple') !== false) echo 'IOS'; else echo 'N/A'; ?></span>
            	<?php } ?>
                ...
                <div class="row margin-top-50">
                    ...
                    <div class="col-lg-4">
                        ...
                        <?php } else { ?>
                        	<span class="d-block f-size-24 slippa-semiblod"><?php if(!empty($listing_data[0]['monthly_downloads'])) echo number_format($listing_data[0]['monthly_downloads']); else echo 'N/A'; ?></span>
		...
		<!-- ad-section / End-->
       	...
       	<?php if(empty($this->session->userdata('user_id'))) { ?>
            ...
            <span class="f-size-24 d-block margin-bottom-30"><h3>About Business</h3></span>
           	<?php } else { ?>
           	<span class="f-size-24 d-block margin-bottom-30"><h3>About App</h3></span>
           	<?php } ?>
			<!-- Meta Description -->
						...
						<div class="domains-overview-inner">
							<ul>
								...
								<li>
									...
									<span>DOWNLOADS</span>
									<h5><?php if(!empty($listing_data[0]['monthly_downloads'])) echo number_format($listing_data[0]['monthly_downloads']); else echo 'N/A'; ?></h5>
								</li>

								<li>
									<i class="fab fa-app-store"></i>
									<span>APP</span>
									<h5><?php if(strpos($listing_data[0]['app_market'], 'google') !== false) echo 'Android App'; else if(strpos($listing_data[0]['app_market'], 'apple') !== false) echo 'IOS App'; else echo 'N/A'; ?></h5>
								</li>
								<?php } ?>
