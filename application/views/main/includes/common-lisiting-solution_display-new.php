...
*/	// pre($ad['website_thumbnail'][0]['name'] , 1)
	...
	if (!empty($ad['id'])) {
?>
		<?php if (isset($ad['sponsorship_priority'])  && $ad['sponsorship_priority'] == 4  || (isset($ad['listing_header_priority']) && $ad['listing_header_priority']  > 1)) { ?>
			<div class="row first_div dropshipping_products_a mb-3 p-4 shadow clearfix  <?php if (isset($ad['listing_header_priority'])  && $ad['listing_header_priority'] != 1) echo "sponsership_bgcolor" ?>">
				...
				<div class="<?php echo $show_image === 1 ? 'col-md-6 custome-height' : 'col-md-9' ?> col-sm-12 title_withbtn">
					<a href="<?php echo base_url() . "$url_proudct/" . $ad['slug'];  ?>">
						<h4 <?php if (isset($ad['listing_header_priority'])  && $ad['listing_header_priority'] == 1) {
							...
							<?php if (isset($ad['website_BusinessName'])) echo $ad['website_BusinessName']; ?>
						</h4>
					</a>
