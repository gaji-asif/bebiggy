		...
		<div class="row first_div mb-3 p-4 shadow <?php if (isset($ad['listing_header_priority']) && $ad['listing_header_priority'] != 1) echo "sponsership_bgcolor" ?>">
			...
			<div class="<?php echo $show_image === 1 ? 'col-md-6' : 'col-md-9' ?> col-sm-12 title_withbtn">
				<h4 <?php if (isset($ad['listing_header_priority']) && $ad['listing_header_priority'] == 1) {
					...
					<?php } elseif (isset($ad['sponsorship_priority']) && $ad['sponsorship_priority']  == 4) {
					...
					<?php } elseif (isset($ad['listing_header_priority']) && $ad['listing_header_priority']  == 3) {
					?>
				...
				<div class="float_right">
								...
								?>
									...
									<?php } else { ?>
										<div class="but_now d-flex">
											<button class="btn btn-default buy_nowbtn d-flex align-item-center"><span>Sold Out</span></button>
										</div>
								<?php
									}
								} ?>
					...
					<div class='row py-2 p-0'>
						<div class="col-md-12 col-sm-12 d-flex w-100 p-0 <?php if ($ad['listing_type'] == 'business' && !empty($this->session->userdata('user_id'))) {
							...
							<a href="<?php echo base_url() . $ad['listing_option'] . '/' . $ad['listing_type'] . '/' . $ad['slug'];  ?>" class="listing" style="background-color: #38bffe; padding: 14px; font-size: 14px; color: #FFFFFF; font-weight: bold; width: 50%; margin-right: 2%; text-align: center;" class="my_btn">View Listing</a>
