			...
			<div class="popup-tab-content" id="tab">
				...
				<div id="bidDiv">
					<div class="welcome-text">
						...
						<br>
						<p align="left">By placing this bid, you are committing to buy <b><?php if (isset($listing_data[0]['website_BusinessName'])) echo $listing_data[0]['website_BusinessName']; ?></b> from <b><?php if (isset($ownerData[0]['username'])) echo $ownerData[0]['username']; ?></b> as per our <a href="javascript:void(0)">Terms and Conditions.</a> The Current Price is <b><?php if (isset($default_currency)) echo $default_currency;
																																																																																												else echo '$'; ?><?php if (isset($currentPrice)) echo number_format(floatval($currentPrice)); ?></b></p>
						<br>
						<h3>Buyer Safety</h3>
						<br>
					...
					<form id="bid-now-form" method="post" enctype="multipart/form-data">
						...
						<div class="input-with-icon-left">
							...
							<input type="hidden" name="bid_gap_value" id="bid_gap_value" value="<?php if (!empty($settings[0]['bid_value_gap'])) echo $settings[0]['bid_value_gap'];
																								else echo 50;  ?>">
						...
						<?php if (!empty($listing_data[0]['website_buynowprice'])) { ?>
							...
							<a href="<?php //echo base_url() . 'checkout/' . 'buynow' . '/' . $listing_data[0]['id']; 
										?>" class="button full-width button-sliding-icon ripple-effect"><span>BUY IT NOW FOR $ <?php// if (!empty($listing_data[0]['website_buynowprice'])) echo number_format($listing_data[0]['website_buynowprice']); ?></span></a> -->
						<?php } ?>
							...
							<ul class="boxed-list-ul">
								<li>
									<div class="bid">
										...
										<div class="bids-bid">
											<div class="bid-rate">
												<div class="rate"><?php if (isset($default_currency)) echo $default_currency;
																	else echo '$'; ?> <?php if (isset($bid['bidder_id'])) echo number_format($bid['bid_amount']); ?></div>
			...
			<div class="popup-tab-content" id="tab">
				...
				<div id="bidDiv">
					<div class="welcome-text">
						...
						<br>
						<p align="left">By placing this offer, you are committing to buy <b><?php if (isset($listing_data[0]['website_BusinessName'])) echo $listing_data[0]['website_BusinessName']; ?></b> from <b><?php if (isset($ownerData[0]['username'])) echo $ownerData[0]['username']; ?></b> as per our <a href="<?php echo base_url('terms-of-services'); ?>" target="_blank">Terms and Conditions.</a> The Asking Price that you can place is <b><?php if (isset($default_currency)) echo $default_currency;
					...
					<form class="offer-now-form" method="post" enctype="multipart/form-data">
						...
						<div class="input-with-icon-left price_show_a shadow">
							<i class="fa fa-usd" aria-hidden="true"></i>
						...
						<?php if (!empty($listing_data[0]['website_buynowprice'])) { ?>
							...
							<h2 class="centerButtons"><b>OR</b></h2>
							<a href="<?php //echo base_url() . 'checkout/' . 'buynow' . '/' . $listing_data[0]['id']; 
										?>" class="button margin-top-35 full-width button-sliding-icon ripple-effect"><span>BUY IT NOW FOR $ <?php//if (!empty($listing_data[0]['website_buynowprice'])) echo number_format($listing_data[0]['website_buynowprice']); ?></span></a> -->
						<?php } ?>
