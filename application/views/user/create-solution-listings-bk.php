	...
	<div class="dashboard-content-container" data-simplebar>
		<div class="dashboard-content-inner" >
			...
			<div class="dashboard-headline">
				<h3><b>Create Solution Listing </b></h3>
				...
				<nav id="breadcrumbs" class="dark">
					<ul>
						...
						<li>Create Solution Listings</li>
					</ul>
				</nav>
			</div>
			<!-- Row -->
						...
						<div class="panel panel-default">
							...
							<!-- Headline -->
								...
								<div class="headline">
									...
									<i class="more-less glyphicon glyphicon-plus"></i><i class="icon-feather-folder-plus panel-title"></i> <b>Step 1: </b> Enter Solution Name</a> <span id="FirstStep" class="badge badge-success">Completed </span></h3>
								</div>
								<?php } else { ?>
								<div class="headline">
									...
									<i class="more-less glyphicon glyphicon-plus"></i><i class="icon-feather-folder-plus panel-title"></i> <b>Step 1: </b> Enter Solution Name </a> <span id="FirstStep" class="badge badge-success" style="display: none;">Completed </span></h3>
								</div>
								<?php }?>
							</div>
								...
								<div class="content with-padding padding-bottom-10">
									<div class="row">
										<div class="col-xl-12">
											...
											<h5>Enter your Solution name<span>(Important)</span>  <i class="help-icon" data-tippy-placement="right" title="Please enter a solution you are want to provide"></i></h5>
											<div class="keywords-container">
												<div class="keyword-input-container">
													<input type="text" id="siteURL" name="siteURL" class="with-border" placeholder="I will develop and design fully responsive web applications" required>
						...
						<div class="panel panel-default">
							...
							<!-- Headline -->
								...
								<div class="headline">
									...
									<i class="more-less glyphicon glyphicon-plus"></i><i class="icon-feather-folder-plus panel-title"></i><b>Step 2: </b> Tell us about your Solution | Provide accurate information about your solution</a> <span id="SecondStep" class="badge badge-success">Completed </span></h3>
								</div>
								<?php } else { ?>
								<div class="headline">
									<h3><a id="secondTab" role="button" data-toggle="collapse" data-parent="#accordion" href="#" aria-expanded="true" aria-controls="collapseTwo">
									<i class="more-less glyphicon glyphicon-plus"></i><i class="icon-feather-folder-plus panel-title"></i><b>Step 2: </b> Tell us about your Solution | Provide accurate information about your solution</a> <span id="SecondStep" class="badge badge-success" style="display: none;">Completed </span></h3>
								</div>
								<?php }?>
							...
							<div class="row">
								...
								<div class="col-xl-6">
									<div class="submit-field">
										<h5>Main Category</h5>
										<select class="required" id="mainCategory" name="mainCategory" class="selectpicker with-border">
											<option value="" selected>Select main category</option>
											<?php
											 foreach($mainCategories as $mainCategory){
												 echo "<option value='".$mainCategory['id']. "'>".$mainCategory['c_name']."</option>";
											 }
											?>
                                        </select>
									</div>
								...
								<div class="col-xl-12">
									<div class="submit-field">
										<h5>Tell us about your domain so potential of your solution. <span>(Important)</span>  <i class="help-icon" data-tippy-placement="right" title="Be Descriptive. Add everything you think which is important"></i></h5>
								...
								<div class="col-xl-6">
								<span><b>Listing Thumbnail Image ,An eye-catching image goes a long way.Upload a photograph of your solutions, product, or service (min 200px x 200px)</b></span>
									<div class="submit-field">
									<div class="uploadButton margin-top-30">
												...
												<span class="uploadButton-file-name-visual"></span>
											</div>
									</div>
									<div class="submit-field">
												<div class="uploadButton margin-top-30">
												...
												<span class="uploadButton-file-name-profit"></span>
											</div>
									</div>
								</div>
								<div class="col-xl-6">
									<span><b>Listing Thumbnail Video ,An eye-catching image goes a long way.Upload a photograph of your solutions, product, or service(mp4) </b></span>
									<div class="submit-field">
										<div class="uploadButton margin-top-30">
											<input class="uploadButton-input-cover" type="file"  accept="video/mp4,video/x-m4v,video/*" id="uploadListingImage" name="uploadListingImage" required/>
											<label class="uploadButton-button ripple-effect" for="uploadListingImage">Upload Video</label>
											<span class="uploadButton-file-name-cover"></span>
										</div>
									</div>
									<div class="submit-field">
										<div class="uploadButton margin-top-30">
											<input class="uploadButton-input-thumb" type="file" accept="video/mp4,video/x-m4v,video/*"  id="uploadThumbnailImage" name="uploadThumbnailImage" required/>
											<label class="uploadButton-button ripple-effect" for="uploadThumbnailImage">Upload Video</label>
									...
									<div id="Sell-Auction-Website" style="display:none;" class="row">
										...
										<div class="col-xl-4">
											<div class="submit-field">
												...
												<input type="text" id="website_startingprice" name="website_startingprice" class="required form-control with-border numeric_validation" placeholder="20" value="<?php if(isset($listing_data[0]['domain_startingprice'])) echo $listing_data[0]['domain_startingprice']; ?>" onkeypress='validateInputNumbers(event)'>
											</div>
										</div>
										...
										<div class="col-xl-4">
											<div class="submit-field">
												...
												<input type="text" id="website_buynowpriceauc" name="website_buynowprice" class=" form-control with-border numeric_validation" placeholder="20" value="<?php if(isset($listing_data[0]['website_buynowprice'])) echo $listing_data[0]['website_buynowprice']; ?>" onkeypress='validateInputNumbers(event)'><small class="text-info"> Leave Empty to disable</small>
											</div>
										</div>
									...
									<div id="Sell-Classified-Website" style="display:none;" class="row">
										...
										<div class="col-xl-4">
											<div class="submit-field">
												...
												<input type="text" id="website_minimumoffer" name="website_minimumoffer" class="required form-control with-border numeric_validation" placeholder="20" value="<?php if(isset($listing_data[0]['domain_sellingprice'])) echo $listing_data[0]['domain_sellingprice']; ?>" onkeypress='validateInputNumbers(event)'>
											</div>
										</div>
