	...
	<div class="sign-in-form">
		...
		<div class="popup-tabs-container">
			...
			<div class="popup-tab-content" id="tab">
				...
				<!-- Button -->
				<button class="margin-top-15 button full-width button-sliding-icon ripple-effect btn_themecolor_a" type="submit" form="acceptOfferForm">Accept <i class="icon-material-outline-arrow-right-alt"></i></button>
				...
				<form name="deliverForm" id="deliverForm" method="POST" enctype="multipart/form-data" action="<?php echo base_url().'main/markAsDelivered'; ?>">
					...
					<div class="submit-field">
						<div class="uploadButton margin-top-30">
							<input class="uploadButton-input-visual upload_proof_a" type="file" accept="image/*, application/pdf" id="uploadProof" name="uploadProof" accept=".pdf" />
						...
						<span class="uploadButton-file-name-visual text-sm">Upload Only PDF File</span>
					</div>
