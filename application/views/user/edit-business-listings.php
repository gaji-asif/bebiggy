...
<body class="gray edit_listingform_a">
		...
		<div class="dashboard-container">
			...
			<div class="dashboard-content-container" data-simplebar>
				<div class="dashboard-content-inner">
					...
					<!-- Row -->
					<div class="row edit_listing_form_a">

						<form id="createListingForm" name="createListingForm" method="POST" enctype="multipart/form-data" class="form_editlisting_a">
							<!-- Dashboard Box -->
							<div class="col-xl-12">
												...
												<div class="content with-padding padding-bottom-10">
													<div class="row">
														...
														<div class="col-xl-6">
															<div class="submit-field">
																<h5>Country</h5>
																<select class="" id="business_registeredCountry" name="business_registeredCountry" class="selectpicker with-border">
														...
														<div class="col-xl-12">
															<div class="submit-field tiny-editor-a">
																<h5>Tell us about your business. What does your business do?<span>(Important) <span class='text-danger'>*</span></span> <i class="help-icon" data-tippy-placement="right" title="Be Descriptive. Add everything you think which is important"></i></h5>
																<!-- <textarea id="summernote"  required name="editordata" rows="5" cols="60" class="form-control"><?php //if (isset($listing_data[0]['description'])) echo $listing_data[0]['description']; 
																																									?></textarea> -->
													...
													<div class="row">
														...
														<div class="col-xl-6">
															<div class="submit-field">
																<div class="uploadButton margin-top-30 upload_imageedit_listing_a">
