...
<head>
	...
	<!--User Page Meta Tags-->
	<title>Create Business Listings | <?php echo $this->lang->line('site_name') ?>| User Dashboard</title>
	<meta charset="utf-8">
				...
				<div class="dashboard-content-inner">
					...
					<div class="dashboard-headline">
						...
						<div class="dashboad_table">
							...
							<h3><b>Create Business Listing </b></h3>
									...
									<div class="panel panel-default">
										...
										<div class="panel-heading" role="tab" id="headingOne">
											...
											<?php if (isset($domainData[0]['domain']) && !empty($domainData[0]['domain'])) { ?>
												<div class="headline">
													<h3><a id="FirstTab" role="button" data-toggle="collapse" data-parent="#accordion" href="#" aria-expanded="true" aria-controls="collapseOne" class="accordion_ expandable_false">
															<i class="more-less glyphicon glyphicon-plus"></i><i class="icon-feather-folder-plus panel-title"></i> <b>Step 1: </b> Business Name </a> <span id="FirstStep" class="badge badge-success">Completed </span></h3>
												</div>
											<?php } else { ?>
												<div class="headline active_accordane">
													<h3><a id="FirstTab" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" class="accordion_ expandable_false">
															<i class="more-less glyphicon glyphicon-plus"></i><i class="icon-feather-folder-plus panel-title"></i> <b>Step 1: </b> Business Name </a> <span id="FirstStep" class="badge badge-success" style="display: none;">Completed </span></h3>
												</div>
											<?php } ?>
										</div>
										...
										<?php if (isset($domainData[0]['domain']) && !empty($domainData[0]['domain'])) { ?>
														...
														<div class="row">
															<div class="col-xl-12">
																<div class="submit-field">
																	...
																	<h5>Enter your Business name <span>(Important)</span> <i class="help-icon" data-tippy-placement="right" title="Please enter a business name"></i></h5>
																	<div class="keywords-container">
																		<div class="keyword-input-container">
																			<input type="text" id="busninessTitle" name="siteURL" class="with-border" placeholder="Enter busniess name" required>
																			<button class="keyword-input-button ripple-effect button-verify-business"><i class="fa fa-check" aria-hidden="true"></i></button>
																		</div>
											...
											<div class="panel panel-default">
												...
												<div class="panel-heading" role="tab" id="headingTwo">
													...
													<?php if (isset($listing_data[0]['website_BusinessName']) && !empty($listing_data[0]['website_BusinessName'])) { ?>
														<div class="headline">
															<h3><a id="secondTab" role="button" data-toggle="collapse" data-parent="" href="#" aria-expanded="true" aria-controls="collapseTwo" class="accordion_ expandable_false">
													...
													<?php } else { ?>
														<div class="headline">
															<h3><a id="secondTab" role="button" data-toggle="collapse" data-parent="#accordion" href="#" aria-expanded="true" aria-controls="collapseTwo" class="accordion_ expandable_false">
												...
												<!---Listing Edit Form Tab ----->
												<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" class="accordion_ expandable_false" aria-labelledby="headingTwo">
													<div class="panel-body">
														...
														<div class="content with-padding padding-bottom-10">
															<div class="row">
																...
																<div class="col-xl-12">
																	<div class="submit-field">
																		<h5>Tell us about your business. What does your business do? <span>(Optional)</span>  <i class="help-icon" data-tippy-placement="right" title="Be Descriptive. Add everything you think which is important"></i> <span class='text-danger'>*</span></h5>
																		<!-- <textarea id="summernote" required name="editordata" rows="5" cols="60" class="form-control"><?php //if (isset($listing_data[0]['description'])) echo $listing_data[0]['description']; ?></textarea> -->
																...
																<div class="col-xl-4">
																	<div class="submit-field">
																		...
																		<input type="text" id="city" name="city" value="<?php if (isset($listing_data[0]['city'])) echo $listing_data[0]['city']; ?>" class="with-border" placeholder="Enter city name" required>
																	</div>
																</div>
																...
																<div class="col-xl-4">
																	<div class="submit-field">
																		<h5>Monetized Since <i class="help-icon" data-tippy-placement="right" title="Should be add date form motitization starts"></i> <span>(Optional)</span> </h5>
																		<input type="text" id="monetized_since" readonly="true" name="monetized_since" value="<?php if (isset($listing_data[0]['monetized_since'])) echo $listing_data[0]['monetized_since']; ?>" class="with-border datepicker" placeholder="yyyy/mm/dd" >
																	</div>
																</div>

																<div class="col-xl-4">
																	<div class="submit-field">
																		<h5>Last 6 Months Avg Revenue <i class="help-icon" data-tippy-placement="right" title="Should be add Last 6 Months Avg Revenue"></i>  <span>(Optional)</span></h5>
																		<input type="text" id="six_months_revenue" name="six_months_revenue" value="<?php if (isset($listing_data[0]['six_months_revenue'])) echo $listing_data[0]['six_months_revenue']; ?>" class="with-border numeric_validation" placeholder="$00"  onkeypress='validateInputNumbers(event)'>
																	</div>
																</div>

																<div class="col-xl-4">
																	<div class="submit-field">
																		<h5>Last 6 Months Avg Profit  <i class="help-icon" data-tippy-placement="right" title="Should be add Last 6 Months Avg Profit"></i> <span>(Optional)</span> </h5>
																...
																<div class="col-xl-8">
																	<div class="submit-field">
																		<h5><b> Financial Overview : </b> Revenue | Expenses | <span>(Net Profit)</span>  <i class="help-icon" data-tippy-placement="right" title="Net Profit will be automatically calculated"></i>  <span>(Optional)</span> </h5>
																		<div class="row">
																			<div class="col-xl-4">
																...
																<div class="col-xl-12">
																	<h5><b> Financial Evidences </b> <i class="help-icon" data-tippy-placement="right" title="Net Profit will be automatically calculated"></i>  <span>(Optional)</span>  </h5>
																	<div class="row">
																		<div class="col-xl-6">
																			<div class="submit-field">
															...
															<div class="row">
																...
																<div class="col-xl-6">
																	<div class="submit-field">
																		<h5>Who would this business be perfect for?     
																...
																<div class="col-xl-12">
																	<div class="submit-field">
																		<div class="uploadButton margin-top-30">
																			<input class="uploadButton-input-thumb" type="file" accept="image/*" id="uploadThumbnailImage" name="uploadThumbnailImage" required /><span class='text-danger'>*</span><label class="uploadButton-button ripple-effect" for="uploadThumbnailImage">Upload Image</label>
											...
											<div class="panel panel-default">
												...
												<div class="panel-heading" role="tab" id="headingThree">
													<?php if (isset($listing_data[0]['listing_option']) && !empty($listing_data[0]['listing_option'])) { ?>
														<!-- Headline -->
														<div class="headline">
															<h3><a id="ThirdTab" role="button" data-toggle="collapse" data-parent="#accordion" href="#" aria-expanded="true" aria-controls="collapseThree" class="accordion_ expandable_false">
												...
												<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
													<div class="panel-body">
														...
														<div class="content with-padding padding-bottom-10">
															...
															<div id="Sell-Auction-Website" style="display:none;" class="row">
																...
																<div class="col-xl-4">
																	<div class="submit-field">
																		...
																		<input type="text" id="website_startingprice" name="website_startingprice" class="W form-control with-border numeric_validation" placeholder="0" onkeypress='validateInputNumbers(event)'>
																	</div>
																</div>
																...
																<div class="col-xl-4">
																	<div class="submit-field">
																		...
																		<input type="text" id="website_reserveprice" name="website_reserveprice" class=" form-control with-border numeric_validation" placeholder="0" onkeypress='validateInputNumbers(event)'><small id="reservredPriceWebsite" class="text-danger"></small>
																	</div>
																</div>
															...
															<div id="Sell-Classified-Website" class="row">

																<div class="col-xl-4">
																	<div class="submit-field">
																		<h5>Asking Price (<?php if (!empty($default_currency)) echo $default_currency; else echo '$'; ?>)</h5>
																		<input type="text" id="BusinessPrice" name="website_minimumoffer" class="form-control with-border numeric_validation" placeholder="0" onkeypress='validateInputNumbers(event)'>
											...
											<div class="panel panel-default">
												...
												<div class="panel-heading" role="tab" id="headingFive">
													<!-- Headline -->
													<div class="headline">
														<h3><a id="FifthTab" role="button" data-toggle="collapse" data-parent="#accordion" href="#" aria-expanded="true" aria-controls="collapseFive" class="accordion_ expandable_false">
																<i class="more-less glyphicon glyphicon-plus"></i><i class="icon-feather-folder-plus panel-title"></i><b>Step 4: </b> Pay & Start Selling</a> <span id="FifthStep" class="badge badge-success" style="display: none;">Completed </span></h3>
													</div>

												</div>

												<!---Listing Edit Form Tab ----->
												<div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive" class="accordion_ expandable_false">
													<div class="panel-body">
											...
											<div class="panel panel-default">
												...
												<div class="panel-heading" role="tab" id="headingSix">
													<!-- Headline -->
													<div class="headline">
														<h3><a id="SixthTab" role="button" data-toggle="collapse" data-parent="#accordion" href="" aria-expanded="true" aria-controls="collapseSix" class="accordion_ expandable_false">
																<i class="more-less glyphicon glyphicon-plus"></i><i class="icon-feather-folder-plus panel-title"></i><b>Step 5: </b> Sponsor Your Listings</a> <span id="SixthStep" class="badge badge-success" style="display: none;">Completed </span></h3>
													</div>
															...
															<div class="row centerButtons">
																...
																<?php if (isset($sponsorOptions)) {
																	...
																	foreach ($sponsorOptions as $option) { ?>
																		...
																		<div class="col-xl-4">
																			<div class="submit-field item">
																				<input id="answer_<?php echo $option['listing_id']; ?>" type="checkbox" name="sponsor_group_1" value="<?php echo $option['listing_id'] ?>" class='sponsored'>
																				<label for="answer_<?php echo $option['listing_id']; ?>"><img src="<?php echo base_url() . ICON_UPLOAD . $option['listing_icon']; ?>" alt="">
																					<h2><b><?php if (!empty($default_currency)) echo $default_currency;
																							else echo '$'; ?><?php if (isset($option['listing_price'])) echo $option['listing_price']; ?></b></h2><strong><?php if (isset($option['listing_name'])) echo $option['listing_name']; ?></strong><?php if (isset($option['listing_description'])) echo html_entity_decode($option['listing_description']); ?><br>
																					<h4><b> Listing Duraton : <?php if (isset($option['listing_duration'])) echo $option['listing_duration']; ?> Days </b></h4>
