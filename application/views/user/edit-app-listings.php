																...
																<div class="row">
																	<div class="col-xl-4">
																		<div class="input-with-icon">
																			<input type="text" id="last12_monthsrevenue" name="last12_monthsrevenue" value="<?php if (isset($listing_data[0]['last12_monthsrevenue']) && !empty($listing_data[0]['last12_monthsrevenue'])) echo $listing_data[0]['last12_monthsrevenue']; ?>" class="with-border numeric_validation" placeholder="$00" onkeypress='validateInputNumbers(event)' required>
																	...
																	<div class="col-xl-4">
																		<div class="input-with-icon">
																			<input type="text" id="last12_monthsexpenses" name="last12_monthsexpenses" value="<?php if (isset($listing_data[0]['last12_monthsexpenses']) && !empty($listing_data[0]['last12_monthsexpenses'])) echo $listing_data[0]['last12_monthsexpenses']; ?>" class="with-border numeric_validation" placeholder="$00" onkeypress='validateInputNumbers(event)' required>
																			<i class="currency"><?php if (isset($default_currency)) echo $default_currency;
																								else echo '$'; ?></i>
																		</div>
																	</div>
														...
														<div id="Sell-Classified-Website" class="row w-100 asing_price_section_a">
															...
															<div class="col-xl-4 col-md-4">
																<div class="submit-field">
																	...
																	<input type="text" class="form-control with-border " id="commission_amount" disabled value="<?php if (isset($listing_data[0]['commission_amount'])) echo $listing_data[0]['commission_amount']; ?>">
														...
														<div id="Sell-Classified-Website" class="row w-100 asing_price_section_a">
															...
															<div class="col-xl-4 col-md-4">
																<div class="submit-field">
																	...
																	<input disabled  type="text" class="form-control with-border "  id="view_asking"  value="<?php if (isset($listing_data[0]['website_minimumoffer'])) echo $listing_data[0]['website_minimumoffer']; ?>" >
