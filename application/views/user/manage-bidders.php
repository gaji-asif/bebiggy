										...
										<div class="seller-overview-inner">
											...
											<div class="seller-name">
												...
												<ul class="dashboard-task-info bid-info">
													<li><strong><?php if(!empty($default_currency)) echo $default_currency; else echo '$'; ?><?php if(isset($bid['bid_amount'])) echo $bid['bid_amount']; ?></strong><span>Bid Amount</span></li>
