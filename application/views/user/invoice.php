												...
												<div class="col-xl-12">
													...
													<main>
														<div class="row contacts">
															...
															<table border="0" cellspacing="0" cellpadding="0" class="margin-top-20">
																...
																<tbody>
																	<tr>
																		...
																		<td class="total"><?php if (!empty($default_currency)) echo $default_currency;
																							else echo '$'; ?><?php if (isset($invoice[0]['gross_amount'])) echo number_format(floatval(($invoice[0]['gross_amount'])), 2); ?></td>
																	</tr>
																</tbody>
																<tfoot>
																	<tr>
																		...
																		<td><?php if (!empty($default_currency)) echo $default_currency;
																			else echo '$'; ?><?php if (isset($invoice[0]['gross_amount'])) echo number_format(floatval(($invoice[0]['gross_amount'])), 2); ?></td>
																	</tr>
																	<tr>
																		<td colspan="0"></td>
																		<td colspan="0">FEE</td>
																		<td><?php if (!empty($default_currency)) echo $default_currency;
																			else echo '$'; ?><?php if (isset($invoice[0]['success_fee'])) echo number_format(floatval(($invoice[0]['success_fee'])), 2); ?></td>
																	</tr>
																	<tr>
																		<td colspan="0"></td>
																		<td colspan="0">TOTAL</td>
																		<td><?php if (!empty($default_currency)) echo $default_currency;
																			else echo '$'; ?><?php if (isset($invoice[0]['gross_amount'])) echo number_format(floatval(($invoice[0]['gross_amount'])) - floatval(($invoice[0]['success_fee'])), 2); ?></td>
																	</tr>
																</tfoot>
															</table>
															...
															<div class="notices">
																<div><b>NOTICE:</b></div>
																<div class="notice">According to terms & conditions a success fee of <b><?php if (!empty($default_currency)) echo $default_currency;
																																		else echo '$'; ?> <?php if (isset($invoice[0]['success_fee'])) echo number_format(floatval(($invoice[0]['success_fee'])), 2); ?></b> has been charged by <b><?php echo $this->lang->line('site_name'); ?></b></div>
															</div>
													</main>
													<footer>
