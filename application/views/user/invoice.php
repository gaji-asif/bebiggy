        					...
        					<div class="col-xl-12">
                				...
                				<div class="row contacts">
                					...
                					<div class="thanks">Thank you!</div>
               	 					<div class="notices">
                    					<div><b>NOTICE:</b></div>
                    					<div class="notice">According to terms & conditions a success fee of <b><?php if(!empty($default_currency)) echo $default_currency; else echo '$'; ?> <?php if(isset($invoice[0]['success_fee'])) echo number_format(floatval(($invoice[0]['success_fee'])),2); ?></b> has been charged by <b><?php echo $this->lang->line('site_name'); ?></b></div>
                					</div>
            					</main>
            					<footer>
