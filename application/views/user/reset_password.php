...
<body>
  <div class="container-scroller">
    <div class="container-fluid page-body-wrapper full-page-wrapper auth-page">
      ...
      <p class="footer-text text-center">copyright © <?php echo date('Y'); ?> <a href="<?php echo base_url(); ?>"> <?php echo $this->lang->line('site_name'); ?> </a> <?php if($settings[0]['footer_credits'] === '1') { ?>  . <?php } ?> All rights reserved.</p>
