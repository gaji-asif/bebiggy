...
<head>
	...
	<!--User Page Meta Tags-->
	<title>Create App Listings | <?php echo $this->lang->line('site_name') ?> | User Dashboard</title>
	<meta charset="utf-8">
									...
									<div class="panel panel-default">
										...
										<div class="panel-heading" role="tab" id="headingOne">
											...
											<?php if (isset($listing_data[0]['app_url']) && !empty($listing_data[0]['app_url']) && $listing_data[0]['app_url'] !== 'n/a') { ?>
												<div class="headline">
													<h3><a id="FirstTab" role="button" data-toggle="collapse" data-parent="#accordion" href="#" class="accordion_ expandable_false" aria-expanded="true" aria-controls="collapseOne" class="accordion_ expandable_false">
															<i class="more-less glyphicon glyphicon-plus"></i><i class="icon-feather-folder-plus panel-title"></i> <b>Step 1: </b> Play Store or Appstore Verification</a> <span id="FirstStep" class="badge badge-success">Completed </span></h3>
												</div>
											<?php } else { ?>
												<div class="headline active_accordane">
													<h3><a id="FirstTab" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" class="accordion_ expandable_false" aria-expanded="true" aria-controls="collapseOne" class="accordion_ expandable_false">
															<i class="more-less glyphicon glyphicon-plus"></i><i class="icon-feather-folder-plus panel-title"></i> <b>Step 1: </b> PlayStore or Appstore Verification</a> <span id="FirstStep" class="badge badge-success" style="display: none;">Completed </span></h3>
												</div>
											<?php } ?>
										</div>
										...
										<?php if (isset($listing_data[0]['app_url']) && !empty($listing_data[0]['app_url']) && $listing_data[0]['app_url'] !== 'n/a') { ?>
														...
														<div class="row">
															<div class="col-xl-12">
																<div class="submit-field">
																	...
																	<h5>Enter the app URL wish to sell<span>(Important)</span> <i class="help-icon" data-tippy-placement="right" title="Please enter your Playstore or Appstore App URL"></i></h5>
											...
											<div class="panel panel-default">
												...
												<div class="panel-heading" role="tab" id="headingTwo">
													...
													<?php if (isset($listing_data[0]['website_BusinessName']) && !empty($listing_data[0]['website_BusinessName'])) { ?>
														<div class="headline">
															<h3><a id="secondTab" role="button" data-toggle="collapse" data-parent="" href="#" aria-expanded="true" class="accordion_ expandable_false" aria-controls="collapseTwo">
																	<i class="more-less glyphicon glyphicon-plus"></i><i class="icon-feather-folder-plus panel-title"></i><b>Step 2: </b> Let's get started | Provide accurate information about your app</a> <span id="SecondStep" class="badge badge-success">Completed </span></h3>
														</div>
													<?php } else { ?>
														<div class="headline">
															<h3><a id="secondTab" role="button" data-toggle="collapse" data-parent="#accordion" href="#" class="accordion_ expandable_false" aria-expanded="true" aria-controls="collapseTwo">
																	<i class="more-less glyphicon glyphicon-plus"></i><i class="icon-feather-folder-plus panel-title"></i><b>Step 2: </b> Let's get started | Provide accurate information about your app</a> <span id="SecondStep" class="badge badge-success" style="display: none;">Completed </span></h3>
														</div>
													<?php } ?>
															...
															<div class="row">
																...
																<div class="col-xl-6">
																	...
																	<div class="submit-field">
																		...
																		<input type="text" id="website_BusinessName" name="website_BusinessName" value="<?php if (isset($listing_data[0]['website_BusinessName'])) echo $listing_data[0]['website_BusinessName']; ?>" class="with-border appName" placeholder="App Name" required>
																...
																<div class="col-xl-6" style="display: none;">
																	<div class="submit-field">
																		<h5>App Age <span>(Years)</span> <i class="help-icon" data-tippy-placement="right" title="Should be add in years"></i></h5>
																...
																<div class="col-xl-6">
																	<div class="submit-field">
																		<h5>App Registered <span class='text-danger'>*</span></h5>
																		<select class="required" id="business_registeredCountry" name="business_registeredCountry" class=" required selectpicker with-border">
																...
																<div class="col-xl-6">
																	<div class="submit-field">
																		...
																		<select class="required" id="website_status" name="website_status" class="selectpicker with-border">
																			<option value="" selected>Status of App</option>
																			<option value="Established" data-file="_app_established">Established</option>
																			<option value="Starter" data-file="_app_starter">Starter</option>
																		</select>
																	</div>
																</div>

																<!--- established section or starter section will include-->
																<div id="selected_section"></div>

																<div class="col-xl-4">
																	<div class="submit-field">
																		<h5>App Industry <span class='text-danger'>*</span></h5>
															...
															<div class="row">
																...
																<div class="col-xl-6">
																	<div class="submit-field">
																		...
																		<input type="text" id="monthly_downloads" name="monthly_downloads" value="<?php if (isset($listing_data[0]['monthly_downloads'])) echo $listing_data[0]['monthly_downloads']; ?>" class="with-border numeric_validation" placeholder="00" onkeypress='validateInputNumbers(event)' required>
																	</div>
																</div>
																...
																<div class="col-xl-6">
																	<div class="submit-field">
																		<div class="uploadButton margin-top-30">
																			...
																			<label class="uploadButton-button ripple-effect" for="uploadThumbnailImage">Upload App Icon Image <span class='text-danger'>*</span> </label>
																		</div>
																		<br>
											...
											<div class="panel panel-default">
												...
												<div class="panel-heading" role="tab" id="headingThree">
													<?php if (isset($listing_data[0]['listing_option']) && !empty($listing_data[0]['listing_option'])) { ?>
														<!-- Headline -->
														<div class="headline">
															<h3><a id="ThirdTab" role="button" data-toggle="collapse" data-parent="#accordion" href="#" class="accordion_ expandable_false" aria-expanded="true" aria-controls="collapseThree">
																	...
																	foreach ($options as $option) { ?>
																		<div class="col-xl-4">
																			<div class="submit-field item">
																				...
																				<label for="website_1_<?php echo $option['radio']; ?>"><img src="<?php echo base_url() . ICON_UPLOAD; ?><?php echo $option['icon']; ?>" alt=""><strong><?php echo $option['name']; ?></strong><?php echo $option['description']; ?>
																			</div>
																		</div>
																<?php }
																} else {
															...
															<div id="Sell-Auction-Website" style="display:none;" class="row">
																...
																<div class="col-xl-4">
																	<div class="submit-field">
																		...
																		<input type="text" id="website_buynowpriceauc" name="website_buynowprice numeric_validation" class=" form-control with-border" placeholder="0" onkeypress='validateInputNumbers(event)'><small class="text-info"> Leave Empty to disable</small>
																	</div>
																</div>
																...
																<div class="col-xl-4">
																	<div class="submit-field">
																		<h5>Actual Price(<?php if (!empty($default_currency)) echo $default_currency;
																							else echo '$'; ?>) <i class="help-icon" data-tippy-placement="right" title="Acutal price must be greater than buy now price. In front this will show like <del>400</del> "></i></h5>
											...
											<div class="panel panel-default">
												...
												<div class="panel-heading" role="tab" id="headingFive">
													<!-- Headline -->
													<div class="headline">
														<h3><a id="FifthTab" role="button" data-toggle="collapse" data-parent="#accordion" href="#" class="accordion_ expandable_false" aria-expanded="true" aria-controls="collapseFive">
																			...
																			<div class="submit-field item">
																				...
																				<label for="answer_<?php echo $option['listing_id']; ?>"><img src="<?php echo base_url() . ICON_UPLOAD . $option['listing_icon']; ?>" alt="">
																					<?php if (!empty($default_currency)) echo $default_currency;
																						...
																						<h2 class="titlte_section_a"><?php if (isset($option['listing_name'])) echo $option['listing_name']; ?>
											...
											<div class="panel panel-default">
												...
												<div class="panel-heading" role="tab" id="headingSix">
													<!-- Headline -->
													<div class="headline">
														<h3><a id="SixthTab" role="button" data-toggle="collapse" data-parent="#accordion" href="" class="accordion_ expandable_false" aria-expanded="true" aria-controls="collapseSix">
																<i class="more-less glyphicon glyphicon-plus"></i><i class="icon-feather-folder-plus panel-title"></i><b>Step 5: </b> Sponsor Your Listings</a></h3>
													</div>
