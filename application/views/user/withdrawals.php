	...
	<div class="dashboard-content-container" data-simplebar>
		<div class="dashboard-content-inner" >
			...
			<div class="dashboard-headline">
				...
				<i class="mdi mdi-currency-usd"></i> <h3>Withdrawals</h3>
			...
			<div class="row">
				...
				<!-- Dashboard Box -->
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0 my_earining">
							...
							<div class="row">
								<div class="col-xl-6">
									<div class="submit-field">
										<h5>Amount to withdraw (<?php if(!empty($default_currency)) echo $default_currency; else echo '$'; ?>)</h5>
										<input id="withdraw_amount" name="withdraw_amount" type="number" class="with-border" value="" placeholder="00">
									</div>
								</div>
