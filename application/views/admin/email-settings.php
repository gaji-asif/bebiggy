		...
		<div class="dashboard-content-inner" >
			...
			<div class="dashboard-headline">
                         ...
                         <div class="dashboad_table">
                            <i class="mdi mdi-email"></i> <h3><b>Email Settings</b></h3>
			...
			<div class="row">
                ...
                <form method="post" name="EmailForm" id="EmailForm" class="login100-form EmailForm">  
                  <div class="card">
                    ...
                    <div class="card-body email_settingsoption_a">
                        ...
                        <div class="form-row below_emailsubscribe_a">    
                        ...
                        <div class="form-group">
                          <button type="submit" class="btn btn-primary save_setting">Save settings</button>
