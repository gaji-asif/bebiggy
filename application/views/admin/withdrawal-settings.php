		...
		<div class="dashboard-content-inner" >
			...
			<div class="dashboard-headline">
                       ...
                       <div class="dashboad_table">
                           <i class="mdi mdi-cash-usd"></i><h3><b>Withdrawal Settings</b></h3>
				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0 margin-bottom-20">
                        ...
                        <div class="form-group">
                            <button type="submit" name="withdrawal_button" class="btn btn-primary theme_btn">UPDATE</button>
			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
						...
						<!-- Headline -->
						<div class="headline request_div">
            ...
            <span id="loaderapp" style="display:none;"> <img src="<?php echo base_url();?>assets/img/loadingimage.gif"/> </span>
						...
						<div class="row">
                    	<div class="col-lg-12 col-xl-12 withdrawal_table p-0">           
                        <div class="card mb-3">
                          <div class="card-body">
