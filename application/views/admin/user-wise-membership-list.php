...
<head>
    ...
    <title>Member hip| <?php echo $this->lang->line('site_name') ?> | Admin Dashboard</title>
    <meta charset="utf-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            <div class="dashboard-box margin-top-0">
                                ...
                                <!-- Headline -->
                                <div class="headline">
                                    <h3><i class="icon-material-outline-assignment"></i> Membership Listings    -    <?php  echo  !empty($membership_history['username']) ? $membership_history['username']: (!empty($membership_details[0]['username']) ? $membership_details[0]['username'] :'') ?></h3>
                                </div>
                                <!-- <div class="col-xl-12">
