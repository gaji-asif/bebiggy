		...
		<div class="dashboard-content-inner" >
			...
			<div class="dashboard-headline">
				...
				<div class="dashboad_table">
                         <i class="icon-material-outline-lock"></i><h3>Password Change</h3>
					...
					<form id="ChangePasswordForm" method="post" enctype="multipart/form-data"/>
						...
						<div class="dashboard-box">
							...
							<div class="content with-padding">
								...
								<div class="row">
									<button type="submit" class="btn btn-success margin-top-30 btntheme_color_a"><?php echo $this->lang->line('lang_btn_change_password'); ?></button>
