		...
		<div class="dashboard-content-inner" >
			...
			<div class="dashboard-headline">
				 ...
				 <div class="dashboad_table">
                            <i class="mdi mdi-book-open-page-variant"></i> <h3>Create Pages</h3>
				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
						...
						<div class="row">
							...
							<div class="col-xl-12">
								<button type="submit" name="btn_pagesave" class="btn btn-success mr-2 save_page">Save</button>
						...
						<!----- PAGES ---------------->
						<div class="row tabel_pagination_a">
                    	<div class="col-xs-24 col-sm-24 col-md-24 col-lg-12 col-xl-12">           
                        <div class="card mb-3">
                          <div class="card-body">
                            <div class="table-responsive">
                              <table id="tbl_pageData" class="table table-bordered table-hover display pages_managers_a">
                      			<thead>
                        			<tr>
                          				<th>ID</th>
                          				<th>TITLE</th>
