...
<head>
	...
	<title>Manage Email Subscribers | <?php echo $this->lang->line('site_name') ?> | Admin Dashboard</title>
	<meta charset="utf-8">
				...
				<div class="dashboard-content-inner">
					...
					<div class="dashboard-headline">
						...
						<div class="dashboad_table">
							...
							<h3>Manage Email Subscribers</h3>
					...
					<nav id="breadcrumbs" class="dark">
						<ul>
							<li><a href="#">Home</a></li>
							<li><a href="javascript:void(0);">Manage Email Subscribers</a></li>
						</ul>
					</nav>
						...
						<div class="col-xl-12">
							<div class="dashboard-box margin-top-0">
								...
								<div class="card">
									...
									<!----- PAGES ---------------->
									<div class="row manage_email_subscriberss_page_a">
										<div class="col-xs-24 col-sm-24 col-md-24 col-lg-12 col-xl-12">
											<div class="card mb-3">
												<div class="card-body">
													<div class="table-responsive">
														<table id="tbl_subscribersData" class="table table-striped table-hover responsive">
															<thead>
																<tr>
																	<th>FIRST NAME</th>
																	<th>LAST NAME</th>
