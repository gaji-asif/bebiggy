                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-xl-12">
                        <div class="submit-field">
                          ...
                          <textarea type="text" class="with-border" id="tiny-editor" name="listing_description"></textarea>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-xl-6 col-sm-12">
                        <div class="submit-field">
                          <label for="category_meta_keywords">Listing Duration<code> (Number of Days)</code></label>
                    ...
                    <div class="row">
                      ...
                      <div class="col-xl-6 col-sm-12">
                        <div class="submit-field">
                          ...
                          <input type="text" class="with-border" id="listing_discount" name="listing_discount" onkeypress='validateInputNumbers(event)' placeholder="Discount" required="true">
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-xl-6 col-sm-12">
                        <div class="submit-field">
                          ...
                          <select class="form-control form-control-lg" id="listing_type" name="listing_type">
                            ...
                            <?php foreach (LISTING_PALNS_TYPES as $k => $v) : ?>
                    ...
                    <button type="submit" name="btn_listingsave" class="btn btn-success mr-2 save_lsit" id="btn_save">Save</button>
