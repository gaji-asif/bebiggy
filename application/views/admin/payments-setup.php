		...
		<div class="dashboard-content-inner" >
			...
			<div class="dashboard-headline">
               ...
               <div class="dashboad_table">
                            <i class="mdi mdi-credit-card-scan"></i> <h3><b>payments Setup</b></h3>
          ...
          <form id="paypal_setup_form" class="forms-sample" method="post" enctype="multipart/form-data"/>
            ...
            <div class="form-group">
                ...
                <div id="defaultPaypalStatus">
                  ...
                  <label class='form-control badge badge-success paypal_active_a'> ACTIVE </label>
                  <?php } else { ?>
                  <label class='form-control badge badge-danger paypal_inactive_a'> INACTIVE </label>
                  <?php } ?>
                </div>
            ...
            <button type="submit" name="btn_paypal" class="btn btn-success mr-2 theme_btn theme_btn">Save</button>
          ...
          <form id="paypalpro_setup_form" class="forms-sample" method="post" enctype="multipart/form-data"/>
            ...
            <button type="submit" name="btn_paypalpro" class="btn btn-success mr-2 theme_btn">Save</button>
          ...
          <form id="stripesetup_form" class="forms-sample" method="post" enctype="multipart/form-data"/>
            ...
            <button type="submit" name="btn_paypal" class="btn btn-success mr-2 theme_btn">Save</button>
