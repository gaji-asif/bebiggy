...
<head>
	...
	<title>Website Industry Manager | <?php echo $this->lang->line('site_name') ?> | Admin Dashboard</title>
	<meta charset="utf-8">
				...
				<div class="dashboard-content-inner">
					...
					<div class="dashboard-headline">
						...
						<div class="dashboad_table">
							...
							<h3>Website Industry Manager</h3>
					...
					<nav id="breadcrumbs" class="dark">
						<ul>
							<li><a href="#">Home</a></li>
							<li><a href="#">Website Industry Manager</a></li>
						</ul>
					</nav>
							...
							<div class="dashboard-box margin-top-0">
								...
								<div class="card">
									<div class="card-body">
										...
										<div class="col-xl-12">
											<div class="submit-field">
												<label for="category_meta_description">Industry Meta Description</label>
										...
										<div class="col-xl-12">
											<div class="submit-field">
												<label for="category_meta_keywords">Industry Meta Keywords <code> (each keyword should be seperated by a comma )</code></label>
										...
										<div class="col-xl-12 d-none">
											<div class="submit-field">
												<label for="category_level">Industry Level</label>
										...
										<div class="d-flex justify-content-end">
											<a href="<?php echo site_url('admin/category_control') ?>" class="btn theme_btn mr-2">Reset</a>
