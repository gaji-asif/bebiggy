			...
			<tbody>
				<?php if (!empty($solutionListing['solution'])) {
					foreach ($solutionListing['solution'] as $listing) { ?>
						<tr>
						<td><a href='javascript:void(0);' data-sid="<?php echo $listing['id']; ?>" data-name="<?php echo $listing['name']; ?>" class="solution_select_page"><?php echo _str_limit($listing['name'] , 10); ?></a></td>
