		...
		<div class="dashboard-content-inner" >
			...
			<div class="dashboard-headline">
					...
					<div class="dashboad_table">
                            <i class="mdi mdi-image-multiple"></i> <h3>Ads Manager</h3>
				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
						...
						<div class="row">
							...
							<div class="col-xl-12">
								<button type="submit" name="btn_adssave" class="btn btn-success mr-2 save_page btntheme_color_a ">Save</button>
