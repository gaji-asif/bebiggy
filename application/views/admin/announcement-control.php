...
<style type="text/css">
  #tbl_announcementdata .editLink { color:#E8692A; }
</style>
		...
		<div class="dashboard-content-inner" >
			...
			<div class="dashboard-headline">
                ...
                <div class="dashboad_table">
                          <i class="mdi mdi-bullhorn"></i><h3><b>Announcements Manager</b></h3>
			...
			<div class="row">
                    ...
                    <div class="card mb-3">
                      <div class="card-body">
                        ...
                        <div class="form-group">
                            <button type="submit" class="button ripple-effect big margin-top-30 theme_btn" style="float: right;" form="announcementForm"><i class="icon-feather-plus"></i> Save</button>
                ...
                <div class="card announcements_div announcements_divsection_a">
                  <div class="card-body">
