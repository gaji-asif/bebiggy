		...
		<div class="dashboard-content-inner" >
			...
			<div class="dashboard-headline">
					...
					<div class="dashboad_table">
                         <i class="icon-material-outline-settings"></i><h3>Admin Settings</h3>
				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
						...
						<div class="content with-padding padding-bottom-0">
							...
							<div class="row profileuser_section_a">

								<div class="col-auto col-sm-12 col-md-3">
						...
						<div class="content">
							...
							<li>
								<div class="row">
									...
									<div class="col-xl-12 div_floats user_setting_a">
										<div class="col-xl-6">
											<div class="submit-field">
