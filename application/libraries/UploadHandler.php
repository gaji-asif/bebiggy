...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        // pre($_FILES);echo dirname($this->get_server_var('SCRIPT_FILENAME'))."/".IMAGES_UPLOAD ; exit ;
        $this->options = array(
            'script_url' => $this->get_full_url().'/'.$this->basename($this->get_server_var('SCRIPT_NAME')) .'/'.'user/deleteTempMedia',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME'))."/".IMAGES_UPLOAD,
            'upload_url' => $this->get_full_url()."/".IMAGES_UPLOAD,
            ...
            'inline_file_types' => '/\.(gif|jpe?g|png|zip)$/i',
            ...
            'accept_file_types' => '/\.(gif|jpe?g|png|doc|docx|jpg|png|jpeg|gif|pdf|mp4|ogg|mov|3gp|wmv|xls|xlsx|txt|avi)$/i',
